...
class Frontend_model extends CI_Model {
  ...
  function update_recaptcha_settings() {
    $data1['description'] = $this->input->post('recaptcha_status');
    $data2['description'] = $this->input->post('recaptcha_sitekey');
    $data3['description'] = $this->input->post('recaptcha_secretkey');
