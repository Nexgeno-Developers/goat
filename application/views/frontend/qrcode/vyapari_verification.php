...
<head>
  ...
  <title>Vyapari Verification | Deonar Goat</title>
...
<body>
  <div class="container mt-4 customer_regis_class">
    ...
    <div class="mb-4 mt-4 text-center">
      <p><b>Vyapari Verification Screen</b></p>
    </div>
...
$(document).ready(function() {
    ...
    function verifyPass(content) {
        ...
        $.ajax({
            url: '<?php echo base_url("Api/vyapari_verify") ?>',
            method: 'POST',
            data: postData,
            beforeSend: function() {
                // $('#result').html(`
            ...
            $('#result').html(`
                ...
                <div class="results_box mt-1 text-center">
                    ...
                    <div class="table-profile">
                      ...
                      <p><b>Registered At:</b> ${response.data.date}</p>
