...
function rightModal(url, header)
{
  ...
  jQuery('#right-modal .modal-body').html('loading...');
  jQuery('#right-modal .modal-title').html('loading...');    
...
<!-- Right modal content -->
<div id="right-modal" class="modal fade" role="dialog" aria-hidden="true" data-backdrop="static">
...
<script>
    $('body').on('click', '#right-modal button.close', function(){
