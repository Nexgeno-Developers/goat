...
<!-- CUSTOM CSS FILES -->
<link href="<?php echo base_url(); ?>assets/backend/css/custom.css?<?= time(); ?>" rel="stylesheet" type="text/css" />
...
<!--insta scanner-->
<script src="<?php echo base_url(); ?>assets/backend/js/custom/instascan.min.js"></script>

<!--sweet alert-->
<script src="<?php echo base_url(); ?>assets/backend/js/custom/sweetalert2.all.min.js"></script>
