<?php 
  ...
  $user = $this->db->where('id', $id)->get('app_broker')->row_array();
?>

<form method="POST" class="d-block ajaxForm" action="<?php echo route('manage_broker/update/'.$id); ?>">
    <div class="form-row">
        ...
        <div class="form-group col-md-12 mt-2">
            <button class="btn btn-block btn-primary btn-ajax" type="submit"><span class="form-button"><?php echo get_phrase('update_broker'); ?></span> <i class="fa fa-spinner fa-spin form-loader" style="display:none"></i></button>
        </div>        
    </div>
</form>
