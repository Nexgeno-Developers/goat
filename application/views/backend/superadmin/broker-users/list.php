          ...
          <tr>
            ...
            <!--    <?php } ?>-->
                */ ?>
                ...
                <a href="javascript:void(0);" class="btn-sm btn-success" onclick="rightModal('<?php echo site_url('modal/popup/broker-users/edit/'.$user['id'])?>', '<?php echo get_phrase('edit_broker'); ?>');"><?php echo get_phrase('edit'); ?></a>
