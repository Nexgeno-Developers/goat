<form method="POST" class="d-block ajaxForm" action="<?php echo route('manage_gwala/create'); ?>">
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="license_type" value="Sheep and Goat Gawal" readonly required>
        </div>
...
<div class="form-group col-md-6"></div>
        ...
        <div class="form-group col-md-2 mt-2">
            <button class="btn btn-block btn-success btn-ajax" type="submit"><span class="form-button"><?php echo get_phrase('add_gawala'); ?></span> <i class="fa fa-spinner fa-spin form-loader" style="display:none"></i></button>
        </div>        
    </div>
</form>
